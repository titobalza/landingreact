...
const Home = () => {
	...
	return (
		...
		<div className="row row-cols-1 row-cols-md-3 row-cols-lg-4 g-4 m-auto">
			...
			imageUrl={getRandomImageUrl()}
			title="Card Title 4"
			text="o beatae vitae dicta sunt explicabo. Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed quia consequuntur magni dolores eos q."
			buttonText="Go somewhere 2"
			/>
		</div>
